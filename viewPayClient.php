...
html 
{ 
    background-color;rgb(213, 182, 213); ; 
}
</script>
</head>
<body style=" background-size:cover; font-family:'Courier New', Courier;">
<style type="text/css">
#data { margin: 25 auto; width:900px; padding:20px; border:#066 thin ridge; height:600px; }
...
<td><?php echo $price; ?>&nbsp; Pesos  </td>
</tr>
<tr><td colspan="4"><center><h2>Total Invoice:<b><i> <?php echo $bill; ?><b>&nbsp;Pesos</h2></center></td></tr>
<?php
$session=$_SESSION['id'];
include 'db.php';
...
<CENTER><a href="billClient.php"><button class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Go back</button></a></CENTER>
</body>
</html>