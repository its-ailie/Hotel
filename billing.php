...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="bills.php"><span class="glyphicon glyphicon-usd"></span>&nbsp;Bill</a></li>
    <li><a href="user.php"><span class="glyphicon glyphicon-user"></span>&nbsp;Users</a></li>
    <li><a href="owner.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Clients</a></li>
      ...
      <div class="col-md-4 ">
         <div class="panel panel-info">
            <div class="panel-heading">
              ...
              <a href="owner.php"><div class="panel-footer"><span class="alert-link glyphicon glyphicon-circle-arrow-right"></span>View</div></a>
         </div>
      </div>
    </div>
   <!-----  ######################################### -->
    ...
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
             ...
             <a href="bills.php"> <div class="panel-footer"><span class="alert-link glyphicon glyphicon-circle-arrow-right"></span>View</div></a>
         </div>
      </div>
    </div>
   <!--------- ########################################### ------>
