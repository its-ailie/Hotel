...
<body class="bg-info" >
  <center>
    <div class="container">   
      ...
      <h1>COSTA LEONA</h1>
        <div id="loginbox" style="margin-top:90px; margin-left:375px;margin-right:800px; width:450px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
