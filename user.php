  ...
  <div class="tab-content">
    ...
    <!-------- home panel ----------------------------->
         ...
         <div class="panel panel-info">
            ...
            <div class="panel-title"><h5>System User</h5></div>
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='deluser.php?id=".$row['id']."'><button class=\"btn btn-danger btn-xs\"><span class=\"glyphicon glyphicon-trash \"></span></button></td>";
