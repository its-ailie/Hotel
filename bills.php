...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="bills.php"><span class="glyphicon glyphicon-usd"></span>&nbsp;Bill</a></li>
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='paymentbill.php?id=".$row['id']."'><span class=\"btn btn-info btn-xs glyphicon glyphicon-usd\"> ADD</span> </a>| ";
